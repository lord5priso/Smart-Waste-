    ...
    <div class="modal-container" id="modalSignalement">
        <div class="modal-content">
          ...
          <br><span style="font-size: 13px;">Cliquez pour prendre une photo</span>
            ...
            <input type="file" id="photoCapture" accept="image/*" capture="environment" style="display: none;" onchange="afficherApercuPhoto(this)">
            
            <input type="text" id="fieldMairie" class="input-field" placeholder="Quartier et Ville (ex: Ndokoti, Douala)">
            
            <textarea id="fieldDescription" class="input-field" placeholder="Description ou détails importants..."></textarea>
            
            <button class="btn-submit" onclick="soumettreFormulaire()">
