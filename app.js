...
function soumettreFormulaire() {
    ...
    // Envoi des données vers le PHP
    let formData = new FormData();
    formData.append('lat', maPosition.lat);
    formData.append('lng', maPosition.lng);
    formData.append('description', desc);
    formData.append('mairie', lieuSaisi); // Prend la valeur finale du champ texte (éditée ou automatique)
    formData.append('photo', fichierPhotoSelectionne);
